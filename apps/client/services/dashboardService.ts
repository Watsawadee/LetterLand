...
import { GamesPlayedPerWeekOrErrorSchema, GamesPlayedPerWeekResponseSchema, TotalPlaytimeOrErrorSchema, WordsLearnedOrErrorSchema } from "@letterland/shared";
import { ErrorResponseSchema } from "@letterland/shared";
const baseUrl =
    Platform.OS === "android"
        ? "http://10.0.2.2:3000"
        : "http://localhost:3000";
